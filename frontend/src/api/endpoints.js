...
export const cardAPI = {
  ...
  assignCard: (cardId, assigneeId) => api.patch(`/cards/${cardId}/assign`, { assigneeId }),
  updatePriority: (cardId, priority) => api.patch(`/cards/${cardId}/priority`, { priority }),
  deleteCard: (id) => api.delete(`/cards/${id}`),
  getChecklists: (cardId) => api.get(`/cards/${cardId}/checklists`),
  addChecklistItem: (cardId, title) => api.post(`/cards/${cardId}/checklists`, { title }),
  toggleChecklistItem: (itemId) => api.patch(`/checklists/${itemId}/toggle`),
  updateChecklistItem: (itemId, title) => api.patch(`/checklists/${itemId}`, { title }),
  deleteChecklistItem: (itemId) => api.delete(`/checklists/${itemId}`),
  duplicateCard: (cardId) => api.post(`/cards/${cardId}/duplicate`),
  restoreCard: (cardId) => api.post(`/cards/${cardId}/restore`),
  getArchivedCards: (boardId) => api.get(`/cards/boards/${boardId}/archived`),
